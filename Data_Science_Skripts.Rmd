...
plot_ly(
  ...
  type = "treemap",
  labels = tabelle_fahrrad_art_df$Art_des_Fahrrads,  # Labels anpassen
  parents = rep("", nrow(tabelle_fahrrad_art_df)),  # Keine Elternkategorie
  values = tabelle_fahrrad_art_df$Anzahl,
...
# Interaktive Version
interactive_map_schadenshoehe_bezirksregion <- ggplotly(p_schadenshoehe_bezirksregion)
...
# Interaktive Version
interactive_map_schadenshoehe_bezirk <- ggplotly(p_schadenshoehe_bezirk,)
